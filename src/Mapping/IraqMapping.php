...
class IraqMapping extends BaseMapping
{
    ...
    public function getFullWordMap(): array
    {
        ...
        return [
            ...
            'حيدر'        => 'Haydar',
            'محمود'       => 'Mahmoud',
            'محمود'       => 'Mahmoud', // Duplicate just for clarity
            'قصي'         => 'Qusay',
            'قيس'         => 'Qais',
            'طه'          => 'Taha',
            'ظافر'        => 'Dhafir',
            ...
            'سيف'         => 'Saif',
            'حارب'        => 'Harib',
            'سامي'        => 'Sami', // Duplicate for clarity
            'معاذ'        => 'Muadh',
            'معن'         => 'Maan',
            'مأمون'       => 'Maamoon',
            'أحمد'        => 'Ahmed',
            'إبراهيم'     => 'Ibrahim', // already covered by 'ابراهيم' but with hamza
            'محمود'       => 'Mahmoud', // re-mention
            'مهنى'        => 'Muhanna',
            'رسول'        => 'Rasool',
            'وسام'        => 'Wesam',
            'ديار'        => 'Diyar',
            ...
            'نرمين'        => 'Narmin',
            'عفراء'        => 'Afraa',
            'حليمه'        => 'Halima', // Variation
            'حميده'        => 'Hamida', // Variation
            'رقية'         => 'Ruqayya', // Variation re-mention
            'سراچ'         => 'Siraj',   // Alternative spelling for 'سراج'
            'سراج'         => 'Siraj',
            'جلال'         => 'Jalal',
            'سعود'         => 'Saud',
            'حنين'         => 'Haneen',
            ...
            'عبد الجليل'      => 'Abd Al-Jalil',
            'عبد الرزاق'      => 'Abd Al-Razzaq',
            'عبد الامير'      => 'Abd Al-Amir',  // no hamza
            'عبد الأمير'      => 'Abd Al-Amir',  // with hamza
            'عبد الحسين'      => 'Abd Al-Hussein',
